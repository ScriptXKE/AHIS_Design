/* [ ---- AHIS - Animal Health Information System - form elements ---- ] */
    ...
    $(document).ready(function() {
        ...
        ahis_sliders.init();
        //* ui progressbars
        ahis_progressbars.init();
        //* 2col multiselect
        ahis_multiselect.init();
        //* enchanced select box
        ahis_enchancedSelect.init();
        //* masked inputs
        ahis_maskedInputs.init();
        //* password strength meter
        ahis_password_meter.init();
        //* datepicker
        ahis_datepicker.init();
        //* timepicker
        ahis_timepicker.init();
        //* colorpicker
        ahis_colorpicker.init();
        //* switch buttons
        ahis_switchButtons.init();
        //* autosize textarea
        ahis_autosize_textarea.init();
        //* textarea counter
        ahis_textarea_counter.init();
        // UI spinners
        ahis_uiSpinners.init();
        //* multiupload
        ahis_multiupload.init();
        //* WYSIWG Editor
        ahis_wysiwg.init();
    });
