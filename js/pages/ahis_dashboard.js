/* [ ---- AHIS - Animal Health Information System - dashboard ---- ] */
    ...
    ahis_todoList = {
        init: function() {
            if($('.todo-list').length) {
                ahis_todoList.checkCompleted();
                ahis_todoList.completeTask();
                ahis_todoList.dragTasks();
                ahis_todoList.countTasks();
                ahis_todoList.countAll();
            }
        },
